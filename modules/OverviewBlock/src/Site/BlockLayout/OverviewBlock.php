<?php
namespace OverviewBlock\Site\BlockLayout;
 ...
 */
class OverviewBlock extends AbstractBlockLayout
{
    /**
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/overview-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/overview-block', [
        'block' => $block,
