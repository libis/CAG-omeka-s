<?php
namespace IntroBlock\Site\BlockLayout;
 ...
 */
class IntroBlock extends AbstractBlockLayout
{
    /**
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/intro-block-form', [
            'block' => $block,
        ]);
    }
