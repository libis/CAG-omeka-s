<?php
namespace CagBrowseBlock\Site\BlockLayout;
...
class CagBrowseBlock extends AbstractBlockLayout
{
    public function getLabel()
    {
        return 'CAG Browse preview'; // @translate
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
        ...
        return $view->partial('common/block-layout/cag-browse-block', [
            'block' => $block,
